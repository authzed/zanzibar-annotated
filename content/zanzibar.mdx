...
* $\mathrm{GROUP2GROUP}(s)\rarr{e}$, where $s$ represents ancestor group and $e$ represents a descendent group that is _directly_ or _indirectly_ a sub-group of the ancestor group.
