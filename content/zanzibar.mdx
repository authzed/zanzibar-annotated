...
<span className="highlight" style={{color:'red'}}>Determining whether online users</span> are authorized to access digital objects is central to preserving privacy.
...
<div className="col-span-2 mb-10 mx-auto">
